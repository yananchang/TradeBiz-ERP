...
<script language="JavaScript">
	...
	function addTRRecord(objId, id, productNo, cnumber, grossWeight, netWeight, sizeLength, sizeWidth, sizeHeight, exPrice, tax) {
		...
		var _tmpSelect = "";
		var tableObj = document.getElementById(objId);   //得到一个table
		var rowLength = tableObj.rows.length;
		
		oTR = tableObj.insertRow();   //js默认提供: 在表格中插入一行
		
		oTD = oTR.insertCell(0);     //在表格行中插入一个cell
		...
		oTD.innerHTML = "&nbsp;&nbsp;";	
		oTD = oTR.insertCell(1);    //在表格行中插入一个cell
