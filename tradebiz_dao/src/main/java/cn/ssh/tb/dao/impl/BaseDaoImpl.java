...
/**
       注意这里并没有继承HibernateDaoSupport, 而是直接注入sessionFactory,这样做的好处:
       兼容Hibernate 3, 4, 5   (Hi4的模板类是有问题的)
 *
 *
 */
public class BaseDaoImpl implements BaseDao{
	...
	public <T> Page<T> findPage(String hql, Page<T> page, Class<T> entityClass, Object[] params){
		...
		page.setResults((List<T>)query.list());     //返回list集合, 是当前页的记录
